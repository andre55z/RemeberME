    ...
    return(
        <div className="w-[90%] max-w-md mx-auto bg-gradient-to-br from-pink-500 to-purple-700 mt-8 p-6 rounded-[30px] flex flex-col items-center shadow-lg">
            ...
            <div className="flex gap-4 mt-6 w-full justify-center">        
                <Button 
                    ClassName="flex-1 max-w-[120px] h-12 text-base rounded-xl bg-red-500 hover:bg-red-400 transition-all duration-300 hover:scale-105 text-white font-medium" 
                    palavraNoBotao="Cancelar" 
                    onClickFunction={onClickFunction}
                />
                <Button 
                    ClassName="flex-1 max-w-[120px] h-12 text-base rounded-xl bg-green-500 hover:bg-green-400 transition-all duration-300 hover:scale-105 text-white font-medium" 
                    palavraNoBotao="Adicionar" 
                    onClickFunction={onClickSuccess}
                />
            </div>
        </div>
            )

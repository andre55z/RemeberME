...
function TaskBox({onClickFunction, setTitulo, setDescricao, titulo, descricao, onClickSuccess}){
    ...
    return(
        <div className="lg:w-[70%] w-[80%] h-[70%] bg-gradient-to-br from-pink-500 to-purple-700 mt-[5%] rounded-[30px] flex flex-col items-center">
            ...
            variable={titulo}/> 
            <textarea 
                className="w-[80%] lg:w-[90%] mt-[5%] outline-none transition-transform hover:scale-105 ease-in-out h-100 rounded-[20px] ml-[1%] p-4 resize-y font-inter text-[110%] bg-amber-50" 

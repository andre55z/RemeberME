...
function TaskBox({onClickFunction, setTitulo, setDescricao, titulo, descricao, onClickSuccess}){
    ...
    return(
        <div className="w-[90%]  max-w-md mx-auto bg-gradient-to-br from-pink-500 to-purple-700 mt-15 p-6 rounded-[30px] animate-fade duration-75 flex flex-col items-center shadow-lg">
